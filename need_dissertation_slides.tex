...
\begin{center}
   ...
   \footnotesize{\textcolor{gray}{Verantwortlichkeit}}
\end{center}
\end{frame}
...
\begin{center}
   ...
   \footnotesize{\textcolor{gray}{Anteil Person A}}
\end{center}
\note{
   \begin{itemize}
...
\begin{itemize}
   ...
   \item $n=400$ (stratifiziert wie oben)
   \item Unparteiische Beobachter*innen
   \item 4 Bedarfsarten, eingebettet in einen hypothetischen Kontext
...
\textbf{Ergebnisse (2/2)}\\
\begin{itemize}
   \item Unparteiische Beobachter*innen schreiben verschiedenen Bedarfsarten unterschiedliche Bedeutsamkeit zi
...
\begin{frame}{\vspace*{10mm}3\hspace*{1em}Bedarf und Bedarfsgerechtigkeit}
\begin{center}
   \frame{\includegraphics[width=0.7\linewidth]{figures/slides_justice.pdf}}
\end{center}
\end{frame}
