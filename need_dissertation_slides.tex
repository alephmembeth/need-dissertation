...
\vspace*{-10mm}
\begin{itemize}
   \item[(1)] Empirische Forschung und normative Theorie
   \item[(2)] Bedarf und Bedarfsgerechtigkeit
   \item[(3)] Bedarf als Referenzpunkt
   \item[(4)] Bedarf und Verantwortung
   \item[(5)] Bedarfsarten
   \item[(6)] Zusammenfassung der zentralen Ergebnisse
\end{itemize}
\end{frame}
