...
\medskip
\begin{itemize}
   \item \enquote{\textit{S} benötigt \textit{X}, um \textit{Z} in \textit{U} zu erreichen} \textcolor{gray}{(Quelle, S. XY)}
   \begin{itemize}
      \item \textit{S}: Subjekt
      \item \textit{X}: Gegenstand
      \item \textit{Z}: Zweck
      \item \textit{U}: Umstände
   \end{itemize}
