...
\begin{titlepage}
   ...
   \end{center}
   \vfill
%    {\Large\noindent  der Carl von Ossietzky Universität Oldenburg -- Fakultät IV, Human- und Gesellschafts­wissenschaften -- zur Erlangung des Grades eines Doctor philosophiae (Dr.\,phil.)}
%    
%    \vspace{0.4cm}
