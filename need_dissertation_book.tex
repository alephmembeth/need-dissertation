...
\renewenvironment{quote}
   {\list{}{\rightmargin=0pt\leftmargin=12pt}%
   \small%
   \item\relax}
   {\endlist}
\makeatother
...
\titlecontents{chapter}
   [6em]
   {\bigskip}
   {\contentslabel[\textsc{\chaptername}~\thecontentslabel]{6em}}
   {\hspace*{-6em}}
...
\par E-Mail:\hspace{1.095cm}\href{mailto:uolp@uni-oldenburg.de}{uolp@uni-oldenburg.de}\\
Internet:\hspace{0.905cm}\href{www.uol.de/bis/uolp}{www.uol.de/bis/uolp}

\par Satz/Layout:\hspace{0.200cm}Alexander Max Bauer mit der \LaTeX{}-Klasse \texttt{tufte-book} von Kevin Godby, Bil Kleb, Bill Wood\\
Umschlag:\hspace{0.570cm}BIS-Druckzentrum (Renate Stobwasser)

\par ISBN 978-3-8142-2419-0
...
Dieses Potential auszuloten, soll aber nicht im Fokus der vorliegenden Arbeit stehen; dieser soll vielmehr auf der deskriptiven Perspektive liegen.
...
Auch unsere zweite Studie baute auf der in Abschnitt~\ref{ch:verantwortung} vorgestellten Vignette auf, wobei wir hier~-- wie sich gleich zeigen wird~-- näher an der ursprünglichen Form sind als in unserer ersten Bedarfsartenstudie.
...
Sie betrachten den Gegenstand damit vorrangig aus einer quantitativen Perspektive.
...
\begin{marginfigure}[-350pt]
   \includegraphics[width=\linewidth]{max.png}
\end{marginfigure}

\marginnote[-3.5cm]{Das Porträt des Autors stammt von \mbox{Spiceestew} (\href{https://spiceestew.carrd.co/}{spicee\-stew.carrd.co}).}
