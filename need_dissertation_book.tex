\documentclass[justified,nobib,nohyper,symmetric,twoside]{tufte-book}
...
\par E-Mail: \href{mailto:bisverlag@uni-oldenburg.de}{bisverlag@uni-oldenburg.de}\\
Internet: \href{www.bis-verlag.de}{www.bis-verlag.de}
...
Ganz besonderer Dank gebührt hier meinen Koautor*innen Adele Diederich, Frauke Meyer, Malte Ingo Meyerhuber, Jan Roman, Mark Siebel, Stefan Traub und Arne Robert Weiß.
...
Ich hätte mir keinen besseren Betreuer meiner Promotion wünschen können.

Ebenso danke ich $\blacksquare$, dem Koreferenten meiner Promotion, sowie den Kommissionsmitgliedern $\blacksquare$, $\blacksquare$ und $\blacksquare$ sehr herzlich.
...
Hier danke ich insbesondere Jessica Allermann, Malte Eggers, Larissa König, Benjamin Rauch, Alexander Stabel, Emily Stabel, Luis Tegenkamp, Tjorven Thranow, Xenia Wolfgramm und Marco Zieger.
...
Experimentelle Philosoph*innen nutzen empirische Forschungsmethoden, um neues Licht auf die Fragen zu werfen, mit denen sie sich befassen.
...
Mit den Ergebnissen der Experimentellen Philosophie aber kann, wie \citep[S.~21]{bauer_zwei_2019} schreiben,
...
Karl \citep[S.~XVI]{popper_logik_1966} hat einmal geäußert, es gäbe \enquote{keine Methode, die für die Philosophie charakteristisch oder wesentlich} sei.
...
% GEGENSTAND %
%%%%%%%%%%%%%%
\chapter{Gegenstand}\label{ch:gegenstand}
...
Abbildung~\ref{fig:abbildung_3} zeigt hier die Gerechtigkeitseinschätzungen der Teilnehmer*innen in der Bedarfsgruppe und Abbildung~\ref{fig:abbildung_4} der Teilnehmer*innen in der Kontrollgruppe als Liniendiagramme.
...
\begin{equation}\label{eq:abweichung}
   \textrm{Abweichung} = \left\{\begin{array}{ll}\frac{\textrm{Anteil Holzscheite}-0,5}{\textrm{Anteil Bedarf}} & \textrm{(Bedarfsszen.)}\\ \\
   \frac{0,5-\textrm{Anteil Holzscheite}}{0,5-\textrm{Anteil Produktivität}} & \textrm{(Produktivitätsszen.)}
   \end{array}
   \right.
\end{equation}
...
\begin{figure}[t]\label{fig:abbildung_11}
   \centering
   \caption{Illustrationen der Bedarfsarten}
   \includegraphics[width=0.4\linewidth]{figure_11.jpg}
   \includegraphics[width=0.4\linewidth]{figure_12.jpg}
   \includegraphics[width=0.4\linewidth]{figure_13.jpg}
   \includegraphics[width=0.4\linewidth]{figure_14.jpg}
\end{figure}
...
Aber selbst in diesen Fällen bekam Person~A noch deutlich mehr Holz zugesprochen, als sie selbst geschlagen hatte, wird also wie in der Verantwortlichkeitsstudie (Abschnitt~\ref{ch:verantwortung}) teilweise für ihren Nachteil kompensiert.
...
%%%%%%%%%%%%%
\cleardoublepage
\chapter*{Über den Verfasser}
\addcontentsline{toc}{chapter}{Über den Autor}
Als Sohn von Marion und Manfred Bauer wuchs Alexander Max Bauer in Darmsheim auf.
...
% Hier promovierte er 2023 mit einer kummulativen Disseration über \enquote{Empirische Studien zur Bedarfsgerechtigkeit}, deren Dachpapier hier in Buchform vorliegt.

Bauer gehört zu den Vertretern der neuen Experimentellen Philosophie.
Hier forscht er mit Methoden aus dem Repertoire der Empirischen Sozialforschung, der Experimentellen Psychologie oder der Experimentellen Ökonomik unter anderem zu Fragen der Verteilungsgerechtigkeit (insbesondere Bedarfsgerechtigkeit) sowie der Wissenschaftstheorie (insbesondere Kausalität).
...
In der Nachfolge von Ingo Elbe, Myriam Gerhard, Philip Hogh und Christine Zunke gibt Bauer außerdem das \textit{Oldenburger Jahrbuch für Philosophie} (BIS-Verlag) heraus, zunächst zusammen mit Nils Baratella, aktuell mit Helena Esther Grass.\\[1em]

\noindent Die Abbildung des Autors stammt von Spiceestew (\href{https://spiceestew.carrd.co/}{spicee\-stew.carrd.co}).
